...
ifeq ($(UNAME),Darwin)
  ...
  ifeq ($(CPU),arm) # iPhone/iPod Touch
    ...
    OS = macosx
    PD_PATH = /usr/local
    OPT_CFLAGS = -O3 -ftree-vectorize -funroll-loops -fomit-frame-pointer
# build universal 32-bit on 10.4 and 32/64 on newer
    ...
    ALL_LDFLAGS += $(FAT_FLAGS) -bundle $(BUNDLE_LOADER) -bundle -bundle_loader /Applications/Pd.app/Contents/MacOs/Pd -undefined dynamic_lookup
